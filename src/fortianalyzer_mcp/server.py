...
def register_dynamic_tools(mcp_server: FastMCP) -> None:
    ...
    async def find_fortianalyzer_tool(operation: str) -> dict[str, Any]:
        ...
        tool_catalog = {
            ...
            "logs": [
                ...
                ("summarize_traffic_logs", "Fetch up to 1000 traffic logs and return a ranked summary grouped by one or more fields (e.g. dstip, dstport) with optional byte sums. Use instead of search_traffic_logs when you need unique values or counts rather than raw log entries."),
    ...
    async def execute_advanced_tool(
        ...
        tool_map = {
            ...
            "summarize_traffic_logs": log_tools.summarize_traffic_logs,

...
def register_dynamic_tools(mcp_server: FastMCP) -> None:
    ...
    async def find_fortianalyzer_tool(operation: str) -> dict[str, Any]:
        ...
        tool_catalog = {
            ...
            "logs": [
                ...
                ("search_security_logs", "Search security/IPS/attack logs"),
                ("search_event_logs", "Search system event logs"),
                ("search_utm_logs", "Search UTM logs: dns, virus, webfilter, app-ctrl, dlp, voip, ssl, file-filter, icap, virtual-patch, utm, anomaly. Supports srcip/dstip/action/level filters and a free-form filter for logtype-specific fields (e.g. qname for DNS)."),
    ...
    async def execute_advanced_tool(
        ...
        tool_map = {
            ...
            "search_utm_logs": log_tools.search_utm_logs,
